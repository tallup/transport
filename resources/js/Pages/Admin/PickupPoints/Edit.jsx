...
export default function Edit({ pickupPoint, routes }) {
    const { auth } = usePage().props;
    const { data, setData, put, processing, errors } = useForm({
        route_id: pickupPoint.route_id || '',
        name: pickupPoint.name || '',
        address: pickupPoint.address || '',
        latitude: pickupPoint.latitude || '',
        longitude: pickupPoint.longitude || '',
        sequence_order: pickupPoint.sequence_order || 0,
    ...
    return (
        <AdminLayout>
            <Head title="Edit Pickup Point" />

            <div className="py-12">
                <div className="max-w-5xl mx-auto sm:px-6 lg:px-8">
                    <GlassCard className="overflow-hidden">
                        <div className="p-6">
                            <h2 className="text-3xl font-extrabold text-white mb-6 drop-shadow-lg">Edit Pickup Point</h2>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                ...
                                <div className="flex justify-end gap-4 mt-6">
                                    ...
                                    <GlassButton
                                        ...
                                        disabled={processing}
                                    >
                                        {processing ? 'Updating...' : 'Update Pickup Point'}
                                    </GlassButton>
                                </div>
                            </form>
                        </div>
