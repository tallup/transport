                        ...
                        <Link href="/admin/bookings?status=pending" className="block group">
                            <GlassCard className="h-full transition-all duration-300 group-hover:scale-[1.03] group-hover:bg-white/20 cursor-pointer">
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="w-12 h-12 bg-orange-500/20 rounded-lg flex items-center justify-center transition-transform group-hover:scale-110">
                            ...
                            <GlassCard className="h-full transition-all duration-300 group-hover:scale-[1.03] group-hover:bg-white/20 cursor-pointer">
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="w-12 h-12 bg-emerald-500/20 rounded-lg flex items-center justify-center transition-transform group-hover:scale-110">
                                        <svg className="w-6 h-6 text-emerald-400 group-hover:text-emerald-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
