            ...
            <div className="py-12">
                <div className="max-w-4xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div className="text-center mb-10">
                        ...
                        <p className="text-lg text-brand-primary/80 font-medium">Complete your booking in a few simple steps</p>
                    </div>
                        ...
                        <div className="p-8 sm:p-10">
                            ...
                            <div className="mb-12">
                                <div className="flex items-center justify-between relative">
                                    ...
                                    <div className="absolute top-4 left-0 right-0 h-1 bg-white/20 rounded-full -z-0"></div>
                            ...
                            {studentIdParam && data.student_id && students && students.length > 0 && (() => {
                                ...
                                return selectedStudent ? (
                                    <div className="mb-8 p-5 bg-gradient-to-r from-blue-500/20 via-blue-500/15 to-blue-500/10 border-2 border-blue-400/40 rounded-xl shadow-lg">
                                        <div className="flex items-center justify-between">
                                            ...
                                            <Link
                                                ...
                                                className="px-4 py-2 bg-blue-500/30 hover:bg-blue-500/40 border border-blue-400/50 rounded-lg text-blue-100 hover:text-white font-semibold text-sm transition-all"
                                            >
                                                Change
                                            </Link>
                                        </div>
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        {students.length === 0 ? (
                                            <div className="text-center py-16">
                                                ...
                                                <p className="text-brand-primary text-lg font-bold mb-4">No students registered yet.</p>
                                                <Link
                                                    href="/parent/students/enroll"
                                                    className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-yellow-400 to-yellow-500 hover:from-yellow-500 hover:to-yellow-600 text-brand-primary font-bold rounded-xl shadow-lg hover:shadow-xl transition-all"
                                                >
                                                    Add a student first
                                                </Link>
                                            </div>
                                ...
                                {step === 4 && (
                                    <div className="space-y-6">
                                        <div>
                                            ...
                                            <p className="text-sm text-brand-primary/70">Please review all details before proceeding to payment</p>
                                        </div>
