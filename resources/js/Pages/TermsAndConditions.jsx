                    ...
                    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <GlassCard className="p-6 md:p-8 space-y-8">
                            ...
                            <section>
                                ...
                                <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-6">3.2 Eligibility</h3>
                                <p className="text-slate-700 leading-relaxed mb-4">
                            ...
                            <section>
                                ...
                                <h3 className="text-xl font-semibold text-slate-900 mb-3">4.1 Booking Process</h3>
                                <p className="text-slate-700 leading-relaxed mb-4">
                                ...
                                <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-6">4.2 Pricing</h3>
                                <p className="text-slate-700 leading-relaxed mb-4">
                                ...
                                <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-6">4.3 Payment Terms</h3>
                                <ul className="list-disc list-inside text-slate-700 space-y-2 ml-4">
                                ...
                                <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-6">4.4 Cancellations and Refunds</h3>
                                <p className="text-slate-700 leading-relaxed mb-4">
                            ...
                            <section>
                                <h2 className="text-2xl font-bold text-slate-900 mb-4">5. Service Standards and Safety</h2>
                                <h3 className="text-xl font-semibold text-slate-900 mb-3">5.1 Safety Requirements</h3>
                                <ul className="list-disc list-inside text-slate-700 space-y-2 ml-4">
                                ...
                                <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-6">5.2 Behavior Standards</h3>
                                <p className="text-slate-700 leading-relaxed mb-4">
                            ...
                            <section>
                                <h2 className="text-2xl font-bold text-slate-900 mb-4">6. Liability and Limitation of Liability</h2>
                                <h3 className="text-xl font-semibold text-slate-900 mb-3">6.1 Service Provision</h3>
                                <p className="text-slate-700 leading-relaxed mb-4">
                                ...
                                <h3 className="text-xl font-semibold text-slate-900 mb-3 mt-6">6.2 Limitation of Liability</h3>
                                <p className="text-slate-700 leading-relaxed mb-4">
                            ...
                            <section>
                                ...
                                <div className="bg-slate-100 rounded-lg p-4 text-slate-700">
                                    ...
                                    <p>Email: support@ontimetransportwa.com</p>
